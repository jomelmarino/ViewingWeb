...
<body>
	...
	<section id="content">
		...
		<nav>
			...
			<hr>
			<li></li><i style="color: black; font-size: 40px; font-family:Arial, Helvetica, sans-serif"> Course: <?php echo $_SESSION['department']; ?></i>
			<hr>
		</nav>
		<!-- NAVBAR -->
...
$query = mysqli_query($conn, "select * from grading where studentID	 = '$studentID'");
while($row = mysqli_fetch_array($query)) {
...
?>
	<td  style="text-align: center;"> : <?php echo $_SESSION['TeacherID'];?></td>
	<td  style="text-align: center;"> <?php echo $_SESSION['SubjectName'];?></td>
	<td  style="text-align: center;"><?php echo $_SESSION['GradeID'];?></td>					
...
$query = mysqli_query($conn, "SELECT gwa FROM grading WHERE studentID = '$studentID'");
while ($row = mysqli_fetch_array($query)) {
